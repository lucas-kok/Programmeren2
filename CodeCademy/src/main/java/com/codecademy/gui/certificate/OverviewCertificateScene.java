...
//            ((NewCertificateScene) getSceneObject("newCourseScene")).resetScene();
...
//
//            // Appending
//            certificateInfoRow.getChildren().addAll(indexLabel, studentEmailLabel, informationDivider, courseNameLabel, informationDivider, certificateScoreLabel);
